document.addEventListener("DOMContentLoaded", function () {
  const flashcards = [
      ...
      { question: "What are  significant figures?", answer: "All certain digits plus the last uncertain digit in a measured value." },
      ...
      { question: "What does the principle of dimensional homogeneity state?", answer: "Both sides of a physical equation must have the same dimensions." },
      ...
      { question: "How do you express random errors quantitatively?", answer: "Using absolute, relative, and percentage errors." },
